<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flashsForm.aspx.cs" Inherits="XCenterCMS.Web.Admin.news.flashsForm" %>
...
<body>
    <form id="form1" action="#">
        ...
        <fieldset style="border:solid 1px #ffffff;padding:3px;">
            <table style="table-layout:fixed; width:100%;">
                <tr>
                    <td style="width:38px; text-align:right;">标题：</td>
                    <td style="width:370px;">
                        <input name="FlashTitle" class="mini-textbox" required="true" style="width:360px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <table style=" margin:0px; padding:0px; border:none;">
                        <tr>                        
                            <td style=" margin:0px; padding:0px; border:none;">
                                <select name="FlashType" class="mini-combobox" style="width:90px;" >
                                    <%=typelist%>
                                </select>
                            </td>
                            <td>
                ...
                <tr>
                    ...
                    <table>
                        <tr>
                            <td rowspan="2" style=" width:128px;" valign="top"><img id="imgThumbPic" style=" width:140px; height:140px; border:1px solid #AAAAAA;" src="<%=imgThumbPic %>" /></td>
                            <td valign="top">
                                <input id="fileupload1" class="mini-fileupload" style=" width:195px;" limitType="*.jpg;*.gif;*.png" limitSize="2MB" flashUrl="../../xcenter/static/fileupload/swfupload/swfupload.swf" uploadUrl="../news/upload.aspx?width=140&height=140" onuploadsuccess="onUploadSuccess1" />
    ...
    <script type="text/javascript">
        ...
        function SaveData() {
            ...
            $.ajax({
                url: "<%= WebRoot %>admin/website/flashs.aspx?handle=SaveOne",
        ...
        function SetData(model) {
            if (model.action == "edit") {
                ...
                $.ajax({
                    type: "POST",
                    dataType: 'json',
                    url: "<%= WebRoot %>admin/website/flashs.aspx?handle=GetOne&id=" + model.id,
                    cache: false,
