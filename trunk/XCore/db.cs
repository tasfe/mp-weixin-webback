...
namespace System {
    ...
    public class db {
        ...
        public static DataPage<T> findPageArchive<T>( String condition, int pageSize ) where T : IEntity {
            ...
            if (strUtil.IsNullOrEmpty( condition )) condition = "order by Guid asc";
            if (condition.ToLower().IndexOf("order") < 0) condition = condition + " order by Guid asc";
        ...
        public static void CommitTransaction()
        {
            ...
            System.Data.DbContext.closeConnectionAll();
        }
        /// <summary>
        /// 回滚事务并关闭连接
        /// </summary>
