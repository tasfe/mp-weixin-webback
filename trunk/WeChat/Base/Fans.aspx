              ...
              <div class="span12">
                <div class="widget-box">
                     <div class="widget-title">
                        <div style=" width:280px; text-align:right; float:right; padding:3px;">
                        ...
                        <div style=" width:210px; text-align:right; float:right; padding:3px;">
                        <select id="AccountFirst" onchange="SetFirstId()">
                            <option value="">全部帐号</option>
                            <%=_WeiXin%>
                        </select> 
                        </div>
                        <h5>
                        我的微信订阅者<span style=" font-weight:normal; color:#999999;">（点击测试功能一列可为用户开启/关闭测试权限）</span>    
                        </h5>
                    </div>
                    <div class="mini-fit" style="clear:both;height:560px;">
                        <div id="datagrid" class="mini-datagrid" style="width:100%;height:100%" pageSize="18" showPageIndex="true" showLoading="false" showTotalCount="true" allowResize="false" url="fans.aspx?action=getlist" idField="Guid" multiSelect="true" >
                            <div property="columns">
                                ...
                                <div field="AccountFirst" width="40" headerAlign="center" align="center" allowSort="false">微信</div>
...
<script type="text/javascript">
    ...
    grid.load();
    function Search() {
        grid.load({ "AccountFirst": $('#AccountFirst').val(), "key": $('#SearchKey').val() }); 
    }
