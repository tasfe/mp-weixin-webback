<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesApiForm.aspx.cs" Inherits="WeChat.Base.RulesApiForm" %><!DOCTYPE html>
<html lang="zh">
<head>
...
<div id="divForm">
    <table style=" width:100%;border-collapse:collapse; border:none;">
        <tr>
            <td id="divLeft">
        <div id="baseFrom">
            <div class="control-title"><h5>开放API接口</h5></div>                            
...
<script type="text/javascript">
    ...
    function GoonSave() {
        $.getJSON("rulesapiform.aspx", { "action": "set", "guid": "<%=_Guid %>"
    ...
    function init() {
        $.getJSON("rulesapiform.aspx", { "action": "get", "guid": "<%=_Guid %>" }, function (json) {
