<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesMPApiForm.aspx.cs" Inherits="WeChat.Base.RulesMPApiForm" %><!DOCTYPE html>
<html lang="zh">
<head>
    <title>API接口-Weback</title>
    <style type="text/css">
...
<div id="divForm">
    <table style=" width:100%;border-collapse:collapse; border:none;">
        <tr>
            <td id="divLeft">
        <div id="baseFrom">
            <div class="control-title"><h5>标准转发接口</h5></div>                            
            ...
            <div class="control-group">
                <label class="control-label" title="">接口地址:</label>
                <div class="controls">
...
<script type="text/javascript">
    ...
    function GoonSave() {
        $.getJSON("rulesmpapiform.aspx", { "action": "set", "guid": "<%=_Guid %>"
    ...
    function init() {
        $.getJSON("rulesmpapiform.aspx", { "action": "get", "guid": "<%=_Guid %>" }, function (json) {
