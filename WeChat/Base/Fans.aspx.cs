            ...
            if (!IsPostBack)
            {
                switch (helper.GetParam("action").ToLower())
                {
                    ...
                    case "getlist":
                        ...
                        if (!string.IsNullOrEmpty(helper.GetParam("AccountFirst")))
                        {
                            where += " and AccountFirst='" + helper.GetParam("AccountFirst") + "'";
                        }
                        ...
                        try
                        {
                            foreach (Wlniao.WeChat.Model.Fans fans in items.Results)
                            {
                                ...
                                try
                                {
                                    fans.AccountFirst = Wlniao.WeChat.Model.WeiXin.findByField("AccountFirst", fans.AccountFirst).WeChatName;
                                }
                                catch { }
                            }
                        }
