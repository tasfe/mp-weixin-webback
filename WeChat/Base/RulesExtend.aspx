<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesExtend.aspx.cs" Inherits="WeChat.Base.RulesExtend" %><!DOCTYPE html>
<html lang="zh">
<head>
...
<div id="content" style=" margin:0px;">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../main.aspx" title="返回首页" class="tip-bottom"><i class="icon-home"></i>未来鸟微信平台</a> <a href="../base/rulesextend.aspx" class="current">扩展开发接口</a></div>   
  </div>
                ...
                <div class="widget-box">
                     <div class="widget-title">
                        <div style="float:right; padding:3px;">
                            <a class="btn btn-primary" href="javascript:void(0);" onclick="add();">添加扩展接口</a>                            
                        </div>
                        <h5>扩展开发接口管理</h5>
                    ...
                    <div id="datagrid" class="mini-datagrid" style="width:100%;" pageSize="18" showPageIndex="true" showLoading="false" showTotalCount="true" allowResize="false" url="rulesextend.aspx?action=getlist" idField="Guid" multiSelect="true" >
                        <div property="columns">
                            ...
                            <div field="RuleConfig" width="270" headerAlign="center" align="left" allowSort="false" renderer="onMethod">方法名</div>
...
<script type="text/javascript">
    ...
    function onMethod(e) {
        ...
        return '<a style="color:gray;">' + cfg.Method + '</a>';
    }
    function SetFirstId() {
    ...
    function add() {
        art.dialog.open(wln.path + '../../base/rulesextendForm.aspx', { title: '添加接口', width: 430, height: 240, lock: true, drag: false, close: function () { ReloadData(); } });
    }
    function edit(guid) {
        art.dialog.open(wln.path + '../../base/rulesextendForm.aspx?Guid=' + guid, { title: '编辑接口', width: 430, height: 240, lock: true, drag: false, close: function () { ReloadData(); } });
    }
    function code(guid) {
