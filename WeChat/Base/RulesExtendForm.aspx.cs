...
{
    public partial class RulesExtendForm : LoginPage
    {
            ...
            if (!IsPostBack)
            {
                switch (helper.GetParam("action").ToLower())
                {
                    ...
                    case "set":
                        ...
                        Wlniao.WeChat.Model.RulesExtendConfig config = new Wlniao.WeChat.Model.RulesExtendConfig();
                        config.Assembly = helper.GetParam("Assembly");
                        config.Method = helper.GetParam("Method");
