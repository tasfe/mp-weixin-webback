<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RulesMPApi.aspx.cs" Inherits="WeChat.Base.RulesMPApi" %><!DOCTYPE html>
<html lang="zh">
<head>
    <title>标准转发接口管理-Weback</title>
    <meta charset="UTF-8" />
...
<div id="content" style=" margin:0px;">
  <div id="content-header">
    <div id="breadcrumb"> <a href="../main.aspx" title="返回首页" class="tip-bottom"><i class="icon-home"></i>未来鸟微信平台</a> <a href="../base/rulesmpapi.aspx" class="current">标准转发接口</a></div>   
  </div>
            ...
            <div class="row-fluid">
              <div class="span12">
                <div class="widget-box">
                    ...
                    <div id="datagrid" class="mini-datagrid" style="width:100%;" pageSize="18" showPageIndex="true" showLoading="false" showTotalCount="true" allowResize="false" url="rulesmpapi.aspx?action=getlist" idField="Guid" multiSelect="true" >
...
<script type="text/javascript">
    ...
    function add() {
        art.dialog.open(wln.path + '../../base/rulesmpapiForm.aspx', { title: '添加接口', width: 430, height: 240, lock: true, drag: false, close: function () { ReloadData(); } });
    }
    function edit(guid) {
        art.dialog.open(wln.path + '../../base/rulesmpapiForm.aspx?Guid=' + guid, { title: '编辑接口', width: 430, height: 240, lock: true, drag: false, close: function () { ReloadData(); } });
    }
    function code(guid) {
