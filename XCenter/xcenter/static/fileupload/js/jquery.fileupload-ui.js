...
(function (factory) {
    ...
    $.widget('blueimpUI.fileupload', parentWidget, {
        options: {
            // 是否开启自动上传:
            autoUpload: false,
            // 允许上传文件的最大数量，The following option limits the number of files that are
            // allowed to be uploaded using this widget:
            maxNumberOfFiles: undefined,
            // 允许上传文件的最大大小，The maximum allowed file size:
            maxFileSize: 3000000, // 3MB，undefined
            // 允许上传文件的最小大小，The minimum allowed file size:
            minFileSize: undefined,
            // 允许上传的文件类型（全部为： /.+$/i   ） /^image\/(gif|jpeg|jpg|png)$/
            // against either file type or file name:
            acceptFileTypes: /^image\/(gif|jpeg|jpg|png)$/,
            // The regular expression to define for which files a preview
            // image is shown, matched against the file type:
            previewSourceFileTypes: /^image\/(gif|jpeg|jpg|png)$/,
            // 容量超过多大的图片不显示缩略图，The maximum file size of images that are to be displayed as preview:
            previewSourceMaxFileSize: 5000000, // 5MB
            // 预览图片的最大宽度，The maximum width of the preview images:
            previewMaxWidth: 80,
            // 预览图片的最大高度，The maximum height of the preview images:
            previewMaxHeight: 80,
