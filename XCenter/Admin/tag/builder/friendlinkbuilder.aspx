...
//------------------------------------------------------------------------------------%>
<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="friendlinkbuilder.aspx.cs" Inherits="XCenterCMS.Web.admin.tags.builder.friendlinkbuilder" %>
...
<title>友情链接标签</title>
    ...
    <script type="text/javascript">
        ...
        function returnValue() {
            ...
            if (flashtype != '') {
                rvalue += ',XCY:FriendLinkType=' + flashtype;
            }
            if (ispic) {
        ...
        <table class="table" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td align="left" valign="middle">
                    ...
                    &nbsp;&nbsp;显示方式：
				    <select name="IsPic" id="Select1" class="form" onchange="javascript:selectIsPic(this.value);" style="min-width:100px;">
	                    <option value="Yes">图片</option>
	                    <option value="No">文本</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td align="left" valign="middle" style=" line-height:1em;">
                    <div>
				        <select class="form" onchange="javascript:selectFieldSet(this.value);" style="width:140px;">
	                        ...
	                        <option value="FriendLinkTitle">图片标题</option>
	                        <option value="nFriendLinkTitle">图片标题全称</option>
